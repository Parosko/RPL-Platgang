...
<div class="d-flex">
    ...
    <div class="content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4>Edit Profil DPA</h4>
                <small><?php echo htmlspecialchars($_SESSION['email']); ?></small>
            </div>
            <a href="../dpa/profile.php" class="btn btn-secondary">Kembali</a>
        </div>
            ...
            <div class="card-body">
                <form method="post" action="../../controllers/dpa/edit_profile_process.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="nama" value="<?php echo htmlspecialchars($profile['nama'] ?? ''); ?>" required>
                    </div>
